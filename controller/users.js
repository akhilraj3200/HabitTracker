        ...
        User.findOne({email: req.body.email}).then(async(result)=>{
            ...
            return res.render('user_sign_up', {title:"User|Sign Up" , err: "Email already exists error", msg : ""})
                ...
                User.create({
                    ...
                    email: req.body.email,
                    password: hashpassword
                }).then((doc)=> {return res.render('user_sign_in', {title:"User | sign in" , err:"", msg : "Account Created Please Login"});}).catch((err)=> { return res.render('user_sign_up', {title:"User|Sign Up" , err: err, msg : ""})})
